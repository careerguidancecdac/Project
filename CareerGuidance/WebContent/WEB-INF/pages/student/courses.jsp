...
<%-- <div id="section1" style="background:<c:url value='/images/webdev.jpeg'></c:url> " class="container-fluid">
 ...
 <div id="section1" class="container-fluid">
	...
	<div class="col-md-2"><a class="button" style="float: inherit;" href="registerCourse/${courses[0].courseid}"><span>Get Started</span></a></div>
 ...
 <div id="section2" class="container-fluid">
	...
	<div class="col-md-2"><a class="button" style="float: inherit;" href="registerCourse/${courses[1].courseid}"><span>Get Started</span></a></div>
