 ...
 --%>  <h1>Complete Your Profile:</h1>
  ...
  <hr>
 	...
 	<div class="form-group">
  			...
  			<div class="col-md-4 inputGroupContainer">
  				<div class="input-group">
  				<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  	<form:select cssStyle="width:400%" path="gender"><form:option value="Male">Male</form:option><form:option value="Female">Female</form:option><form:option value="Other">Other</form:option></form:select>
    			</div>
 		 	</div>
 	</div>
 	 <div class="form-group">
  			...
  			<div class="col-md-4 inputGroupContainer">
  				<div class="input-group">
  				<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  			<form:input type="date" id="dob" path="dob" cssStyle="width:105%" required="true"/>
    			</div>
 		 	</div>
 	</div> 
 		<div class="form-group">
  			...
  			<div class="col-md-4 inputGroupContainer">
  				<div class="input-group">
  				<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  				<form:input id="phone" path="contact" placeholder="phone"  cssStyle="width:400%" required="true"/>
    			</div>
 		 	</div>
 	</div>	
  ...
  <hr>
    <div class="form-group">
  			...
  			<div class="col-md-4 inputGroupContainer">
  				<div class="input-group">
  				<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  				<form:select id="country" path="country" cssStyle="width:400%" required="true"><form:option value="--select country--"></form:option></form:select>
  ...
  <div class="form-group">
  			...
  			<div class="col-md-4 inputGroupContainer">
  				<div class="input-group">
  				<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  				<form:select id="state" path="state" cssStyle="width:400%" required="true"><form:option value="--select state--"></form:option></form:select>
  ...
  <div class="form-group">
  			...
  			<div class="col-md-4 inputGroupContainer">
  				<div class="input-group">
  				<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  				<form:select id="city" path="city" cssStyle="width:400%" required="true"><form:option value="--select city--"></form:option></form:select>
