...
<body>
	...
	<div class="container mt-3">	
  	 	<div class="form-group row">
  			...
  			<div class="col-xs-2">
     			<input class="form-control" type="text" id="searchbycourse" placeholder="Search By Courses">
  			</div>
  			...
  			<div class="col-xs-3" style="width: 250px">
	     		<input class="form-control" type="text" id="searchbyplacement" placeholder="Search By Placement Status">
  			</div>  			
		</div>
   				...
   				<tbody id="myTable">   
               		<c:forEach var="s" items="${stud_obj}">
                  		<tr>
                   			...
                   			<td><a href="student_activestatus?regno=${s[1].regno}">${s[1].accstatus}</a></td>
                   			<td>${s[1].fname}</td>
                   			<td>${s[1].lname}</td>
