   				...
   				<tbody id="myTable">   
               		<c:forEach var="p" items="${postedjobs_obj}">
                  		<tr>    
                   			...
                   			<td>${p[3].sscmarks}</td>
                   			<td>${p[3].hscmarks}</td>
                   			<td>${p[3].diplomamarks}</td>
                   			<td>${p[3].gradmarks}</td>
                   			<td>${p[3].pgmarks}</td>
                   			<td>${p[2]}</td>
                   			<td><a href="shortlist_students?companyName=${p[1]}&jobId=${p[3].jobId}&emailid=${p[2]}&sscmarks=${p[3].sscmarks}&hscmarks=${p[3].hscmarks}&diplomamarks=${p[3].diplomamarks}&gradmarks=${p[3].gradmarks}">ShortlistStudents</a></td>	
							<!--  -->
						</tr>
					</c:forEach>
				</tbody>
