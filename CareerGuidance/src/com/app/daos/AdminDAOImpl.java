...
public class AdminDAOImpl implements AdminDAO
{
	...
	@Override
	public void changeStudActiveStatus(long regno) 
	{
	...
	@Override
	public void changeStudPlacementStatus(long regno) 
	{
		Student s=(Student)sf.getCurrentSession().get(Student.class, regno);
	...
	{	
		String jpql="SELECT s from Student s where s.sscpercent>= :sscmarks and s.hscpercent>= :hscmarks and s.diplomapercent>= :diplomamarks and s.gradpercent>= :gradmarks and s.placed!=true and s.accstatus!=false";
